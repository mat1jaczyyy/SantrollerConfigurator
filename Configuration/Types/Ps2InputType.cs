...
public enum Ps2InputType
{
    ...
    NegConL,
    [Description("JogCon - Wheel Axis")]
    JogConWheel,
    [Description("Guitar - Whammy Axis")]
    GuitarWhammy,
    ...
    Dualshock2R2,
    [Description("NegCon - A Button")]
    NegConA,
    [Description("NegCon - B Button")]
    NegConB,
    [Description("NegCon - Start Button")]
    NegConStart,
    [Description("NegCon - R Button")]
    NegConR,
    ...
    GuitarOrange,
    [Description("Guitar - Strum Up")]
    GuitarStrumUp,
    [Description("Guitar - Strum Down")]
    GuitarStrumDown,
    [Description("Guitar - Select Button")]
    GuitarSelect,
    [Description("Guitar - Start Button")]
    GuitarStart,
    [Description("Guitar - Tilt")]
    GuitarTilt,
