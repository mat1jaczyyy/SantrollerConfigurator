...
public enum WiiInputType
{
    ...
    GuitarJoystickY,
    [Description("Guitar - Whammy")]
    GuitarWhammy,
    [Description("Guitar - Slider")]
    GuitarTapBar,
    ...
    [Description("Nunchuk - Pitch")]
    NunchukRotationPitch,
    [Description("Nunchuk - Roll")]
    NunchukRotationRoll,
    [Description("Turntable - Left Spin")]
    DjTurntableLeft,
    ...
    UDrawPenY,
    [Description("UDraw - Pen Pressure")]
    UDrawPenPressure,
    ...
    DrawsomePenPressure,
    [Description("Guitar - Green Fret")]
    GuitarGreen,
    [Description("Guitar - Red Fret")]
    GuitarRed,
    [Description("Guitar - Yellow Fret")]
    GuitarYellow,
    [Description("Guitar - Blue Fret")]
    GuitarBlue,
    [Description("Guitar - Orange Fret")]
    GuitarOrange,
    ...
    GuitarTapOrange,
    [Description("Guitar - Minus Button")]
    GuitarMinus,
    [Description("Guitar - Plus Button")]
    GuitarPlus,
    [Description("Guitar - Strum Up Button")]
    GuitarStrumUp,
    [Description("Guitar - Strum Down Button")]
    GuitarStrumDown,
    [Description("Drum - Green Pad")]
    DrumGreen,
    [Description("Drum - Red Pad")]
    DrumRed,
    [Description("Drum - Yellow Pad")]
    DrumYellow,
    [Description("Drum - Blue Pad")]
    DrumBlue,
    [Description("Drum - Orange Pad")]
    DrumOrange,
    [Description("Drum - Minus Button")]
    DrumMinus,
    [Description("Drum - Plus Button")]
    DrumPlus,
    [Description("Drum - Kick Pedal")]
    DrumKickPedal,
    [Description("Nunchuk - C Button")]
    NunchukC,
    [Description("Nunchuk - Z Button")]
    NunchukZ,
    [Description("UDraw - Pen Click")]
    UDrawPenClick,
    [Description("UDraw - Pen Button 1")]
    UDrawPenButton1,
    [Description("UDraw - Pen Button 2")]
    UDrawPenButton2,
    [Description("Taiko - Left Rim Hit")]
    TaTaConLeftDrumRim,
    [Description("Taiko - Left Center Hit")]
    TaTaConLeftDrumCenter,
    [Description("Taiko - Right Rim Hit")]
    TaTaConRightDrumRim,
