...
public struct Board
{
    ...
    {
        new("a-micro", "Arduino Micro in Bootloader Mode", 16000000, "a-micro", new List<uint> {0x0037, 0x0237},
            false),
        ...
        new("micro", "Arduino Pro Micro in Bootloader Mode", 8000000, "micro", new List<uint> {0x9203, 0x9207},
            false),
