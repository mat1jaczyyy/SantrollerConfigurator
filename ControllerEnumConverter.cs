    ...
    private static readonly Dictionary<Tuple<DeviceControllerType, RhythmType?, StandardButtonType>, string>
        ButtonLabels =
            new()
            {
                ...
                {new(DeviceControllerType.Guitar, RhythmType.GuitarHero, StandardButtonType.X), "Yellow Fret"},
                {new(DeviceControllerType.Guitar, RhythmType.GuitarHero, StandardButtonType.Y), "Blue Fret"},
                ...
                {new(DeviceControllerType.Guitar, RhythmType.RockBand, StandardButtonType.X), "Lower Yellow Fret"},
                {new(DeviceControllerType.Guitar, RhythmType.RockBand, StandardButtonType.Y), "Lower Blue Fret"},
